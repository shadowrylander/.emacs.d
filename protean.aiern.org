...
(cond (meq/var/phone (progn
                        (meq/wrapped-call "Adding unstable repo" pkg install unstable-repo -y)
                        (meq/wrapped-call "Adding root repo" pkg install root-repo -y)
                        (meq/wrapped-call "Updating pkgs" pkg update -y)
                        (mapc #'(lambda (pkg) (interactive)
                            (meq/install-package pkg "pkg")) '(;; clang
                                                                ;; fftw
                                                                ;; freetype
                                                                gitea
                                                                ;; libcrypt
